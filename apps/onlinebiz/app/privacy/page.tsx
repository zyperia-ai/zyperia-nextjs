...
export const metadata: Metadata = {
  title: 'Privacy Policy | Earn Online',
...
export default function PrivacyPage() {
  return (
    <div className="max-w-3xl mx-auto space-y-8 py-12">
      <div>
        <h1 className="text-4xl font-bold text-gray-900 mb-2">Privacy Policy & GDPR</h1>
      ...
      <section className="space-y-6">
        <div>
          ...
          <ul className="space-y-2 text-gray-700">
            ...
            <li>• <strong>Product Clicks:</strong> Which tools and products you interact with</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-700">
            ...
            <li>• <strong>Beehiiv/Resend:</strong> Manages our newsletter service</li>
            <li>• <strong>Affiliate Networks:</strong> Gumroad, Hotmart, Skillshare, etc. (see Affiliate Disclosure)</li>
        ...
        <div>
          ...
          <p className="text-gray-700">
            ...
            <a href="mailto:privacy@zyperia.ai" className="text-green-600 hover:text-green-700">
              privacy@zyperia.ai
            </a>
          </p>
        </div>
