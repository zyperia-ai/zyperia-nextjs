  ...
  return (
    <main className="min-h-screen bg-slate-900">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-6 border-2 border-green-600 rounded-lg overflow-hidden bg-slate-800 h-32">
          <img
        ...
        <p className="text-center text-slate-300 text-sm mb-4">
          Build, scale, and monetize your online business
        </p>

        {/* Buttons */}
        <div className="flex gap-3 justify-center mb-6">
          <button className="px-4 py-2 bg-green-600 text-white text-sm rounded font-semibold hover:bg-green-700">
            📧 Subscribe
          </button>
