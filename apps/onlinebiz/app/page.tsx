export default function Home() {
  return (
    <main className="w-screen h-screen bg-slate-900 flex flex-col">
      ...
      <div className="w-full h-16 bg-green-900 border-b border-green-600">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4">
        ...
        <div className="flex gap-1 mb-2">
          <button className="px-2 py-0.5 bg-green-600 text-white text-xs rounded font-semibold hover:bg-green-700">
            Subscribe
          </button>
