...
export async function generateMetadata(
  ...
  if (!article) {
    return { title: 'Artigo não encontrado — ZYPERIA OnlineBiz' }
  }
  const description = (article as any).meta_description || article.excerpt || article.title
  return {
    title: `${article.title} — ZYPERIA OnlineBiz`,
    ...
    <main className="min-h-screen pt-24 pb-20">
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(generateArticleStructuredData({
            ...
            slug: article.slug,
            image: (article as any).og_image_url || 'https://onlinebiz.zyperia.ai/og-image.png',
      ...
      <div className="max-w-3xl mx-auto px-4">
        ...
        <Link href="/articles" className="btn-ghost text-sm mb-8 inline-flex items-center gap-2">
          <ArrowLeft size={14} /> Voltar aos casos de estudo
        </Link>
        ...
        {/* Newsletter signup */}
        <NewsletterForm source="onlinebiz" variant="inline" />
