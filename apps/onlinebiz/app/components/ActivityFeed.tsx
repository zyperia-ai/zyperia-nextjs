    ...
    <div className="space-y-6">
        ...
        >
          <div className="p-6">
            ...
            <Link href={`/articles/${article.slug}`}>
              <h3 className="text-xl font-bold text-gray-900 hover:text-green-600 mb-2">
                {article.title}
              </h3>
            </Link>
      ...
      {articles.length < total && (
        <button
          ...
          disabled={loading}
          className="w-full py-3 text-green-600 hover:text-green-700 font-medium disabled:opacity-50"
        >
