...
export default function ReferralDashboard() {
  ...
  return (
    <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-8 max-w-2xl mx-auto">
        ...
        <>
          <div className="grid grid-cols-3 gap-4 mb-6">
            <div className="bg-white rounded-lg p-4 text-center">
              ...
              <p className="text-4xl font-bold text-green-600">{referralCode.clicks}</p>
            </div>
            <div className="bg-white rounded-lg p-4 text-center">
