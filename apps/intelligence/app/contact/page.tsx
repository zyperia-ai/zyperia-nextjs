...
export const metadata: Metadata = {
  title: "Contacto — ZYPERIA Intelligence",
      ...
      <div className="container-narrow max-w-3xl">
        ...
        <div className="prose-zyperia">
          <p>
            ...
            a quase tudo em 3 dias úteis. Se és operador com um playbook que vale a
            pena escrever — ou tens uma história de guerra sobre uma automação que
            explodiu em produção — especialmente queremos ouvir-te.
          </p>

          <p className="text-sm text-[var(--text-muted)]">
            <strong>Imprensa &amp; parcerias:</strong> pitches de vendors para
            patrocínios da newsletter vão para hi@zyperia.ai. Não aceitamos pedidos
            tipo "podem escrever um playbook sobre a nossa ferramenta" — playbooks
            são escolhidos editorialmente, não encomendados.
          </p>
        </div>
      </div>
    </div>
