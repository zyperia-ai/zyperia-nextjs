...
export async function generateMetadata(
  ...
  if (!article) {
    return { title: 'Artigo não encontrado — ZYPERIA Intelligence' }
  }
  const description = (article as any).meta_description || article.excerpt || article.title
  return {
    title: `${article.title} — ZYPERIA Intelligence`,
    ...
    openGraph: {
      ...
      images: (article as any).og_image_url
        ...
        : [{ url: 'https://intelligence.zyperia.ai/og-image.png', width: 1200, height: 630 }],
    },
    twitter: {
      ...
      images: (article as any).og_image_url
        ...
        : ['https://intelligence.zyperia.ai/og-image.png'],
    },
  }
}
        ...
        <article>
          ...
          <div className="mb-12 py-8 border-t border-white/10">
            ...
            <ShareArticle
              ...
              variant="full"
              baseUrl="https://intelligence.zyperia.ai"
            />
          </div>
        </article>
