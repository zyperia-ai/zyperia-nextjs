    ...
    <div className="space-y-6">
        ...
        >
          <div className="p-6">
            ...
            <Link
              ...
              className="mt-4 inline-block text-purple-600 font-medium hover:text-purple-700"
            >
              Read article →
            </Link>
          </div>
      ...
      {articles.length < total && (
        <button
          ...
          disabled={loading}
          className="w-full py-3 text-purple-600 hover:text-purple-700 font-medium disabled:opacity-50"
        >
