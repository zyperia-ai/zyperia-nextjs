      ...
      <html>
        <head>
          ...
          <style>
            ...
            .header { background: linear-gradient(135deg, #7C6FF7 0%, #6C5FE7 100%); color: white; padding: 30px; border-radius: 8px; text-align: center; }
            .content { padding: 30px; border: 1px solid #e0e0e0; border-radius: 8px; margin: 20px 0; }
            .button { display: inline-block; background: #7C6FF7; color: white; padding: 12px 30px; border-radius: 6px; text-decoration: none; font-weight: 600; }
        ...
        <body>
          <div class="container">
            ...
            <div class="footer">
              ...
              <p><a href="https://unsubscribe.example.com" style="color: #7C6FF7;">Unsubscribe</a> | <a href="https://preferences.example.com" style="color: #7C6FF7;">Update preferences</a></p>
            </div>
          </div>
        </body>
      </html>
      ...
      <html>
        <head>
          ...
          <style>
            ...
            .container { max-width: 600px; margin: 0 auto; padding: 20px; }
            .header { background: linear-gradient(135deg, #7C6FF7 0%, #6C5FE7 100%); color: white; padding: 30px; border-radius: 8px; text-align: center; }
            .article { padding: 20px; border-left: 4px solid #7C6FF7; margin: 15px 0; background: #f9f9f9; }
            .article-title { font-size: 18px; font-weight: 600; margin: 0; }
            .article-link { display: inline-block; color: #7C6FF7; text-decoration: none; font-weight: 600; margin-top: 10px; }
            .footer { text-align: center; color: #888; font-size: 12px; margin-top: 30px; padding-top: 20px; border-top: 1px solid #e0e0e0; }
          </style>
        </head>
        <body>
            ...
            <div style="padding: 30px;">
              ...
              ${topArticles
                ...
                <div class="article">
                  ...
                  <a href="https://intelligence.zyperia.ai/articles/${article.slug}" class="article-link">Read Article →</a>
                </div>
              `
                )
                .join('')}
      ...
      <html>
        <head>
          ...
          <style>
            ...
            .author { color: #7C6FF7; font-weight: 600; font-size: 14px; }
          ...
          <div class="container">
            <div class="article-card">
              ...
              <p style="margin-top: 20px;">
                <a href="https://intelligence.zyperia.ai/articles/${article.slug}" class="button">Read Full Article</a>
              </p>
            </div>
          </div>
        </body>
        ...
        <body>
          <div class="container">
            <div class="card">
              ...
              <p style="margin-top: 20px;">
                <a href="https://intelligence.zyperia.ai/articles/${article.slug}#comments" class="button">View Reply</a>
              </p>
            </div>
          </div>
        </body>
