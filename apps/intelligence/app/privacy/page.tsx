...
export const metadata: Metadata = {
  title: 'Privacy Policy | Intelligence',
      ...
      <section className="space-y-6">
        <div>
          ...
          <ul className="space-y-2 text-gray-700">
            ...
            <li>• <strong>Affiliate Clicks:</strong> Which tools you interact with</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-700">
            ...
            <li>• <strong>Affiliate Networks:</strong> Zapier, Make, OpenAI, etc. (see Affiliate Disclosure)</li>
        ...
        <div>
          ...
          <p className="text-gray-700">
            ...
            <a href="mailto:privacy@zyperia.ai" className="text-blue-600 hover:text-blue-700">
              privacy@zyperia.ai
            </a>
          </p>
        </div>
