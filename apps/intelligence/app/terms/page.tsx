...
export const metadata: Metadata = {
  title: "Termos de Serviço — ZYPERIA Intelligence",
    ...
    <div className="min-h-screen px-4 py-20">
      <div className="container-narrow max-w-3xl">
        ...
        <div className="prose-zyperia">
          ...
          <p>
            A ZYPERIA Intelligence publica playbooks técnicos e guias sobre IA e
            automação. O conteúdo é informativo e educativo. Qualquer workflow,
            arquitectura, prompt ou padrão de integração que descrevemos deve ser
            testado em ambiente piloto não-crítico antes de ser implementado em
            produção. Falhas em automações de negócio podem causar perda de dados,
            interrupção operacional, e dano financeiro — não aceitamos
            responsabilidade por resultados de implementar a nossa orientação.
          </p>
