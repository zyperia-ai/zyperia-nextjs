...
export default function TrendingArticles({
  ...
  return (
    <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg p-6 my-8">
          ...
          <Link key={article.id} href={`/articles/${article.slug}`}>
            <div className="bg-white rounded-lg p-4 hover:shadow-md transition-shadow cursor-pointer">
              <div className="flex items-start">
                <span className="text-2xl font-bold text-blue-600 mr-4 min-w-fit">
                  {index + 1}
                </span>
                <div className="flex-1">
                  <h4 className="font-semibold text-slate-900 hover:text-blue-600 mb-1">
                    {article.title}
                  </h4>
